...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repetir', 'webtranslations' ),
		'repeat-x'  => __( 'Repetir Horizontalmente', 'webtranslations' ),
		'repeat-y'  => __( 'Repetir Verticalmente', 'webtranslations' ),
		'repeat'    => __( 'Repetir todo', 'webtranslations' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Arriba Izquierda', 'webtranslations' ),
		'top center'    => __( 'Arriba Centro', 'webtranslations' ),
		'top right'     => __( 'Arriba Derecha', 'webtranslations' ),
		'center left'   => __( 'Medio Izquierda', 'webtranslations' ),
		'center center' => __( 'Medio Centro', 'webtranslations' ),
		'center right'  => __( 'Medio Derecha', 'webtranslations' ),
		'bottom left'   => __( 'Abajo Izquierda', 'webtranslations' ),
		'bottom center' => __( 'Abajo Centro', 'webtranslations' ),
		'bottom right'  => __( 'Abajo Derecha', 'webtranslations')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Desplazamiento Normal', 'webtranslations' ),
		'fixed'  => __( 'Estático en un lugar', 'webtranslations')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'webtranslations' ),
		'italic'      => __( 'Cursiva', 'webtranslations' ),
		'bold'        => __( 'Negrita', 'webtranslations' ),
		'bold italic' => __( 'Negrita Cursiva', 'webtranslations' )
		);
